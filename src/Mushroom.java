...
/**
 * The Mushroom class is used to contain the data for each mushroom found in the
 * datafile. More info on each attribute in agaricus-lepiotaexplanation.txt.
 *
...
public class Mushroom {
    ...
    public Mushroom(Cap_Color c, Cap_Shape s) {
        
    }

    /**
     * Returns a list (as .class objects) of the different attribute types. Note
     * that the class label is not added to this list of attributes.
     *
     * @return
     */
    ...
    public static List<Object> getAttributeEnum(Object attribute) {
        List<Object> result = new ArrayList<>();
        
        if (attribute.equals(Class_Label.class)) {
            return Arrays.asList(Class_Label.values());
        }
        if (attribute.equals(Cap_Shape.class)) {
            return Arrays.asList(Cap_Shape.values());
        }
        if (attribute.equals(Cap_Surface.class)) {
            return Arrays.asList(Cap_Surface.values());
        }
        if (attribute.equals(Cap_Color.class)) {
            return Arrays.asList(Cap_Color.values());
        }
        if (attribute.equals(Bruises.class)) {
            return Arrays.asList(Bruises.values());
        }
        if (attribute.equals(Odor.class)) {
            return Arrays.asList(Odor.values());
        }
        if (attribute.equals(Gill_Attachment.class)) {
            return Arrays.asList(Gill_Attachment.values());
        }
        if (attribute.equals(Gill_Spacing.class)) {
            return Arrays.asList(Gill_Spacing.values());
        }
        if (attribute.equals(Gill_Size.class)) {
            return Arrays.asList(Gill_Size.values());
        }
        if (attribute.equals(Gill_Color.class)) {
            return Arrays.asList(Gill_Color.values());
        }
        if (attribute.equals(Stalk_Shape.class)) {
            return Arrays.asList(Stalk_Shape.values());
        }
        if (attribute.equals(Stalk_Root.class)) {
            return Arrays.asList(Stalk_Root.values());
        }
        if (attribute.equals(Stalk_Surface_Above_Ring.class)) {
            return Arrays.asList(Stalk_Surface_Above_Ring.values());
        }
        if (attribute.equals(Stalk_Surface_Below_Ring.class)) {
            return Arrays.asList(Stalk_Surface_Below_Ring.values());
        }
        if (attribute.equals(Stalk_Color_Above_Ring.class)) {
            return Arrays.asList(Stalk_Color_Above_Ring.values());
        }
        if (attribute.equals(Stalk_Color_Below_Ring.class)) {
            return Arrays.asList(Stalk_Color_Below_Ring.values());
        }
        if (attribute.equals(Veil_Type.class)) {
            return Arrays.asList(Veil_Type.values());
        }
        if (attribute.equals(Veil_Color.class)) {
            return Arrays.asList(Veil_Color.values());
        }
        if (attribute.equals(Ring_Number.class)) {
            return Arrays.asList(Ring_Number.values());
        }
        if (attribute.equals(Ring_Type.class)) {
            return Arrays.asList(Ring_Type.values());
        }
        if (attribute.equals(Spore_Print_Color.class)) {
            return Arrays.asList(Spore_Print_Color.values());
        }
        if (attribute.equals(Population.class)) {
            return Arrays.asList(Population.values());
        }
        if (attribute.equals(Habitat.class)) {
            return Arrays.asList(Habitat.values());
        }
